  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
            <h1>Shipora</h1>
            <p>Aplikasi Manajemen Dokumen Kapal</p>
            <div class="d-flex">
              @auth
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Tentang Kita</h2>
        <p>Shipora adalah aplikasi manajemen dokumen kapal yang mempermudah proses pengiriman dan pemeriksaan dokumen.</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Visi & Misi Shipora</h3>
            <p class="fst-italic">
              Shipora hadir untuk membuat pengelolaan dokumen kapal menjadi lebih efisien, aman, dan terorganisir.
            </p>
            <ul>
              <li><i class="bi bi-check2-all"></i> <span>Memudahkan admin mengunggah dokumen langsung melalui aplikasi.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Memastikan atasan bisa memeriksa dan mengoreksi dokumen dengan mudah.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Mengurangi risiko dokumen hilang atau salah kirim.</span></li>
            </ul>
            <p>
              Dengan Shipora, seluruh proses pengelolaan dokumen kapal menjadi lebih cepat, transparan, dan terdokumentasi dengan baik, sehingga dapat bekerja lebih efisien.
            </p>
          </div>
        </div>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <span>Kontak</span>
        <h2>Kontak</h2>
        <p>Hubungi kami untuk informasi lebih lanjut atau pertanyaan seputar aplikasi Shipora.</p>
      </div><!-- End Section Title -->
          ...
          <div class="col-xl-12">
            ...
            <div class="info-wrap">
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h3>Address</h3>
                  <p>Lingkungan Klatakan, Klatak, Kec. Kalipuro, Kabupaten Banyuwangi, Jawa Timur 68421</p>
                </div>
              </div><!-- End Info Item -->
              ...
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
                ...
                <div>
                  <h3>Email Us</h3>
                  <p>pertaminatranskontinental@gmail.com</p>
                </div>
              </div><!-- End Info Item -->

              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3949.4665251690303!2d114.38946617477013!3d-8.155661791874856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd1469de49916e5%3A0xdf914baa785c6a23!2sPT.%20Pertamina%20Trans%20kontinental%20Cabang%20Banyuwangi!5e0!3m2!1sid!2sid!4v1756095568261!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
